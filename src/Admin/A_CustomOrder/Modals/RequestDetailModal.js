...
const RequestDetailModal = ({ show, order, handleClose }) => {
  // 🔥 Toast 상태 관리
  ...
  return (
    <GenericModal show={show} handleClose={handleClose} title="요청 상세 정보">
      {!order ? (
            ...
            <div className="card">
              <div className="card-body">
                <div className="d-flex justify-content-around">
                  ...
                  <button className="btn btn-outline-success">견적전송</button>
